...
function get_todos() {
    ...
    var todos=new Array;
    /*this pulls the task that was saved in the wed browser memory*/
    var todos_str=localStorage.getItem('todo');
    /*if the input is not null then JSON.parse will communitcate with the web 
    browser to make the task a JavaScript object.*/
    if(todos_str !== null){
...
function add(){
    ...
    todos.push(task);
    /*this converts the task inputto a JSON.string*/
